...
const { genSingleTxInput } = require("../scripts/gen_single_tx_input.js");
const assert = require("assert");
const crypto = require("crypto");
const { genDepositInput } = require("../scripts/gen_deposit_input.js");
...
describe("Rollup contract", function () {
    it("Deployment", async function () {
        ...
        console.log(await processed.wait());
        console.log(await rollup.nonce());
    });
});